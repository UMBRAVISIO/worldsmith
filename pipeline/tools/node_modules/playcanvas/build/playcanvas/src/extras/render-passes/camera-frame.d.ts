...
export type ColorLUT = {
    ...
    /**
     * - The strength of the primary LUT, blended against the original
 ...
 * `localSpotLights`.
 */
export type VolumetricFog = {
    /**
     * - Whether the volumetric fog is enabled. Defaults to false.
     */
    enabled: boolean;
    /**
     * - The directional light providing the scattered light, or
    ...
    /**
     * - Whether the clustered omni lights scatter light in the fog.
    ...
    /**
     * - The number of raymarching steps taken inside the volume of each
    ...
    density: number;
    /**
     * - The world space height at which the fog density starts to fall
     * off. Below it the density is constant. Defaults to 0.
     */
    heightBase: number;
    /**
     * - The exponential falloff of the fog density with height above
     * the base height. Value of 0 makes the fog uniform. Defaults to 0.05.
     */
    heightFalloff: number;
    /**
     * - A scale of how quickly the fog absorbs the light passing through
    ...
    extinction: number;
    /**
     * - The anisotropy of the scattering, 0-0.95 range. Larger values
    ...
    intensity: number;
    /**
     * - The color of the ambient in-scattered light, which keeps the
     * fog in shadowed areas visible. Defaults to white.
     */
    ambientColor: Color;
    /**
     * - The intensity of the ambient in-scattered light. Defaults
     * to 0.02.
     */
    ...
    maxDistance: number;
    /**
     * - The number of raymarching steps, 4-128 range. Higher values improve
     * the quality at a higher performance cost. Defaults to 24.
     */
    steps: number;
    /**
     * - The resolution scale of the fog texture relative to the scene
...
export class CameraFrame {
     ...
     */
    debug: null | "scene" | "ssao" | "bloom" | "vignette" | "dofcoc" | "dofblur" | "depth";
     ...
     * @private
     */
    private _volumetricFogSupported;
    /**
