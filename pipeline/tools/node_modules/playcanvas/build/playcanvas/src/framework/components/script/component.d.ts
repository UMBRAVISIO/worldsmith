...
export class ScriptComponent extends Component {
    ...
    _scriptsIndex: {};
    _declarationOrder: any[];
    _destroyedScripts: any[];
    _destroyed: boolean;
    _scriptsData: readonly ScriptType[];
    _oldState: boolean;
     ...
     * @type {Script[]}
     */
    set scripts(value: ReadonlyArray<ScriptType>);
    /**
     ...
     */
    get scripts(): ReadonlyArray<ScriptType>;
