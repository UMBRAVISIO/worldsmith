...
export class ApplicationStats {
     ...
     * @ignore
     */
    updateBasic(now: number, dt: number, ms: number, renderer: ForwardRenderer, device: GraphicsDevice): void;
    /**
     ...
     * @ignore
     */
    updateDetailed(renderer: ForwardRenderer, device: GraphicsDevice): void;
    /**
