...
export class AppBase extends EventHandler {
     ...
     * @ignore
     */
    tick: (timestamp?: number, xrFrame?: XRFrame) => void;
    /**
    ...
    applySceneSettings(settings: {
        ...
        render: {
            ...
            lightingMaxLights?: number;
            lightingShadowType?: number;
            lightingCells?: number[];
            gsplatRadialSorting?: boolean;
            gsplatLodUpdateDistance?: number;
            gsplatLodUpdateAngle?: number;
            gsplatLodBehindPenalty?: number;
            gsplatLodUnderfillLimit?: number;
            gsplatSplatBudget?: number;
            gsplatLodMode?: string;
            gsplatAlphaClip?: number;
            gsplatAlphaClipForward?: number;
            gsplatMinPixelSize?: number;
            gsplatMinContribution?: number;
            gsplatFoveationStrength?: number;
            gsplatFoveationCenter?: number;
            gsplatAntiAlias?: boolean;
            gsplatUseFog?: boolean;
            gsplatUseTonemap?: boolean;
            gsplatColorUpdateAngle?: number;
            gsplatCooldownTicks?: number;
            gsplatDataFormat?: string;
            gsplatEnableIds?: boolean;
        };
    }): void;
    /**
    ...
    /** @private */
    private _onSkyboxRemoved;
    /** @private */
    private _onSkyboxChanged;
    /** @private */
    private _firstBake;
    /** @private */
    private _firstBatch;
     ...
     */
    destroy(): void;
    _gsplatSortedEvt: import("../index.js").EventHandle;
    context: any;
    /**
     ...
     * @deprecated Use the Fullscreen API directly.
     */
    enableFullscreen(element?: Element, success?: Function, error?: Function): void;
    /**
     ...
     * @deprecated Use the Fullscreen API directly.
     */
    disableFullscreen(success?: Function): void;
    /**
     ...
     */
    getSceneUrl(name: string): string | null;
    /**
     * Loads a scene.
     *
     ...
     */
    loadSceneSettings(url: string, callback: Function): void;
}
