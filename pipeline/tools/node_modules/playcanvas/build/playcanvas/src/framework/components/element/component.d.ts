...
export class ElementComponent extends Component {
     ...
     * @type {number[]}
     */
    set layers(value: ReadonlyArray<number>);
    /**
    ...
    _calcScreenCorners(left: any, bottom: any, right: any, top: any, corners: any): any;
    /**
     ...
     */
    set fontAsset(arg: Asset | number | null);
    /**
     * Gets the id of the font asset used for rendering the text.
     *
     * @type {Asset | number | null}
     */
    get fontAsset(): Asset | number | null;
    /**
     ...
     * @type {Asset | number | null}
     */
    set textureAsset(arg: Asset | number | null);
    /**
     * Gets the id of the texture asset to render.
     *
     * @type {Asset | number | null}
     */
    get textureAsset(): Asset | number | null;
    /**
     ...
     * @type {Asset | number | null}
     */
    set materialAsset(arg: Asset | number | null);
    /**
     ...
     * @type {Asset | number | null}
     */
    set spriteAsset(arg: Asset | number | null);
    /**
     * Gets the id of the sprite asset to render.
     *
     * @type {Asset | number | null}
     */
    get spriteAsset(): Asset | number | null;
    /**
