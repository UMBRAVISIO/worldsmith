...
export class GraphicsDevice extends EventHandler {
     ...
     * @readonly
     */
    readonly supportsSubgroupSizeControl: boolean;
    /**
     ...
     * @readonly
     */
    readonly supportsLinearIndexing: boolean;
    /**
     ...
     * @readonly
     */
    readonly supportsPointerCompositeAccess: boolean;
    /**
     ...
     * @readonly
     */
    readonly supportsPacked4x8IntegerDotProduct: boolean;
    /**
     ...
     * @readonly
     */
    readonly supportsTextureAndSamplerLet: boolean;
    /**
     ...
     * @readonly
     */
    readonly supportsUnrestrictedPointerParameters: boolean;
    /**
     ...
     * @readonly
     */
    readonly supportsTransientAttachments: boolean;
    /**
     ...
     * @readonly
     */
    readonly supportsDualSourceBlending: boolean;
    /**
     ...
     * @readonly
     */
    readonly supportsIndependentBlending: boolean;
    /**
     ...
     * @readonly
     */
    readonly textureFloatBlendable: boolean;
    /**
     ...
     * @ignore
     */
    get extBlendMinmax(): boolean;
    /**
     * @deprecated Always returns true.
     * @ignore
     */
    get extTextureHalfFloat(): boolean;
    /**
     * @deprecated Always returns true.
     * @ignore
     */
    get extTextureLod(): boolean;
    /**
     * @deprecated Always returns true.
     * @ignore
     */
    get textureHalfFloatFilterable(): boolean;
    /**
     * @deprecated Always returns true.
     * @ignore
     */
    get supportsMrt(): boolean;
    /**
     * @deprecated Always returns true.
     * @ignore
     */
    get supportsVolumeTextures(): boolean;
    /**
     * @deprecated Always returns true.
     * @ignore
     */
     ...
     * @ignore
     */
    get extTextureFloat(): boolean;
    /**
     * @deprecated Always returns true.
     * @ignore
     */
    get extStandardDerivatives(): boolean;
    /**
     ...
     * @ignore
     */
    setColorWrite(redWrite: boolean, greenWrite: boolean, blueWrite: boolean, alphaWrite: boolean): void;
    getBlending(): boolean;
    /**
     * @deprecated Use GraphicsDevice.setBlendState instead.
