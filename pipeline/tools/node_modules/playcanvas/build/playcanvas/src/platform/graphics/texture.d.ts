...
export class Texture {
    ...
    _gpuSize: number;
    /** @ignore */
    releaseSourceAfterUpload: boolean;
    /** @protected */
    protected id: number;
    /** @protected */
     ...
     * @ignore
     */
    setReleaseSourceAfterUpload(): void;
     ...
     * @ignore
     */
    set swizzleGGGR(value: boolean);
    /**
     * @deprecated Use Texture#type instead.
     * @ignore
     */
    get swizzleGGGR(): boolean;
    get _glTexture(): any;
    /**
     ...
     */
    get pot(): boolean;
    get encoding(): "rgbm" | "rgbe" | "rgbp" | "srgb" | "linear";
    dirtyAll(): void;
