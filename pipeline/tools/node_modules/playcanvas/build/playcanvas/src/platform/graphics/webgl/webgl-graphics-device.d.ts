...
export class WebglGraphicsDevice extends GraphicsDevice {
    ...
    dynamicBuffers: WebglDynamicBuffers;
    supportsImageBitmap: boolean;
    _samplerTypes: Set<35678 | 35680 | 36306 | 36298 | 35682 | 36293 | 35679 | 36299 | 36307 | 36289 | 36303 | 36311>;
    glAddress: (10497 | 33071 | 33648)[];
    glBlendEquation: (32774 | 32778 | 32779 | 32775 | 32776)[];
    glBlendFunctionColor: any[];
    glBlendFunctionAlpha: any[];
    glComparison: (512 | 513 | 514 | 515 | 516 | 517 | 518 | 519)[];
    glStencilOp: (0 | 7680 | 7681 | 7682 | 34055 | 7683 | 34056 | 5386)[];
    glClearFlag: number[];
    glCull: number[];
    glFrontFace: (2305 | 2304)[];
    glFilter: (9728 | 9729 | 9984 | 9986 | 9985 | 9987)[];
    glPrimitive: (0 | 3 | 1 | 2 | 4 | 5 | 6)[];
    glType: (5120 | 5121 | 5122 | 5123 | 5124 | 5125 | 5126 | 5131)[];
    pcUniformType: {};
    targetToSlot: {};
    commitFunction: {}[];
    ...
    createUniformBufferImpl(uniformBuffer: any): WebglUniformBuffer;
    createBindGroupFormatImpl(bindGroupFormat: any): WebglBindGroupFormat;
    createBindGroupImpl(bindGroup: any): WebglBindGroup;
    /**
    ...
    createXrBridgeImpl(xrBridge: any): WebglXrBridge;
    ...
    extBlendFuncExtended: ANGLE_instanced_arrays;
    extDrawBuffersIndexed: ANGLE_instanced_arrays;
    ...
    transformFeedbackBuffers: VertexBuffer[] | null;
    /**
     ...
     * @ignore
     */
    resolveMsaaColorToXrFramebufferViaQuads(msaaReadFbo: WebGLFramebuffer, xrDrawFbo: WebGLFramebuffer, width: number, height: number): void;
    /**
     ...
     * @ignore
     */
    copyTextureToTexture(source: Texture, dest: Texture, options?: object): boolean;
    /**
     * Start a render pass.
     *
     ...
     * @ignore
     */
    removeVertexArrayFromCache(vertexBuffers: VertexBuffer[]): void;
     ...
     * @ignore
     */
    readPixelsAsync(x: number, y: number, w: number, h: number, pixels: ArrayBufferView, forceRgba?: boolean, frequent?: boolean): Promise<ArrayBufferView<ArrayBufferLike>>;
     ...
     * @ignore
     */
    setTransformFeedbackBuffers(buffers: VertexBuffer[] | null): void;
    /**
     ...
     * @private
     */
    private applyBlendStateIndexed;
