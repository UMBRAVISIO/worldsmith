export class WebgpuGraphicsDevice extends GraphicsDevice {
     ...
     * @private
     */
    private _canvasBackBufferFormat;
    /**
     ...
     * @ignore
     */
    setXrBackBufferFormat(viewFormat: any): void;
    initDeviceCaps(): void;
    maxPrecision: string;
    maxTextures: any;
     ...
     */
    writeStorageBuffer(storageBuffer: WebgpuBuffer, bufferOffset: number, data: ArrayBufferView | ArrayBuffer, dataOffset: number, size: number): void;
    /**
