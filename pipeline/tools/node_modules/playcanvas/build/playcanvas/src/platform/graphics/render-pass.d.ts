 ...
 * @ignore
 */
export class RenderPass extends FramePass {
    /**
     ...
     */
    setClearColor(color: Color | undefined, index?: number): void;
    /**
 ...
 * @ignore
 */
export function validateClearValues(renderPass: RenderPass): void;
