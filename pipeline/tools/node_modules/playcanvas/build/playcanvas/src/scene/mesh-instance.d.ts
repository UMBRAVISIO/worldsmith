 ...
 */
export type CalculateSortDistanceCallback = (meshInstance: MeshInstance, cameraPosition: Vec3, cameraForward: Vec3) => number;
/**
...
export class MeshInstance {
     ...
     * @ignore
     */
    getShaderInstance(shaderPass: number, lightHash: number, scene: Scene, cameraShaderParams: CameraShaderParams, viewUniformFormat?: UniformBufferFormat, sortedLights?: any): ShaderInstance;
    /**
     ...
     */
    getParameter(name: string): object | undefined;
    /**
     ...
     */
    setParameter(name: string, data: number | number[] | Texture | Float32Array): void;
    /**
     ...
     * @ignore
     */
    setParameters(device: GraphicsDevice): void;
    /**
