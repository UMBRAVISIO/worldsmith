...
export class Camera {
     ...
     * @ignore
     */
    publishSceneDepthMap(texture: Texture, renderVersion: number): void;
    /**
    ...
    set projectionOffset(newValue: Vec2);
