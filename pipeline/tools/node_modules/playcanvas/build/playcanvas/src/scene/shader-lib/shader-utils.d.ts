...
export class ShaderUtils {
     ...
     * @ignore
     */
    static getScreenDepthChunkKey(cameraShaderParams: CameraShaderParams): string;
    /**
     ...
     * @ignore
     */
    static addScreenDepthChunkDefines(cameraShaderParams: CameraShaderParams, defines: Map<string, string>): string;
}
