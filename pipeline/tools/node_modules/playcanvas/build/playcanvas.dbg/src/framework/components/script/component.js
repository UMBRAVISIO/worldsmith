...
class ScriptComponent extends Component {
  ...
  constructor(system, entity) {
     ...
     * @private
     */
    __publicField(this, "_attributeDataMap", /* @__PURE__ */ new Map());
    this._scripts = [];
 ...
 * });
 */
__publicField(ScriptComponent, "EVENT_CREATE", "create");
/**
 ...
 * });
 */
__publicField(ScriptComponent, "EVENT_DESTROY", "destroy");
/**
 ...
 * });
 */
__publicField(ScriptComponent, "EVENT_ENABLE", "enable");
/**
 ...
 * });
 */
__publicField(ScriptComponent, "EVENT_DISABLE", "disable");
/**
 ...
 * });
 */
__publicField(ScriptComponent, "EVENT_REMOVE", "remove");
/**
 ...
 * });
 */
__publicField(ScriptComponent, "EVENT_STATE", "state");
/**
 ...
 * });
 */
__publicField(ScriptComponent, "EVENT_MOVE", "move");
/**
 ...
 * });
 */
__publicField(ScriptComponent, "EVENT_ERROR", "error");
export {
  ScriptComponent
};
