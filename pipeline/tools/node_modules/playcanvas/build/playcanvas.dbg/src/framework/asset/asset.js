...
class Asset extends EventHandler {
  ...
  constructor(name, type, file, data = {}, options = {}) {
     ...
     * @private
     */
    __publicField(this, "_i18n", {});
    /**
     * Whether to preload the asset.
     *
     * @private
     */
    __publicField(this, "_preload", false);
    /**
     ...
     * @type {number}
     */
    __publicField(this, "id", assetIdCounter--);
    /**
     ...
     * @ignore
     */
    __publicField(this, "urlObject", null);
    this._name = name || "";
    this.type = type;
    this._data = data || {};
 ...
 * });
 */
__publicField(Asset, "EVENT_LOAD", "load");
/**
 ...
 * });
 */
__publicField(Asset, "EVENT_UNLOAD", "unload");
/**
 ...
 * });
 */
__publicField(Asset, "EVENT_REMOVE", "remove");
/**
 ...
 * });
 */
__publicField(Asset, "EVENT_ERROR", "error");
/**
 ...
 * });
 */
__publicField(Asset, "EVENT_CHANGE", "change");
/**
 ...
 * });
 */
__publicField(Asset, "EVENT_PROGRESS", "progress");
/**
 ...
 * });
 */
__publicField(Asset, "EVENT_ADDLOCALIZED", "add:localized");
/**
 ...
 * });
 */
__publicField(Asset, "EVENT_REMOVELOCALIZED", "remove:localized");
export {
  Asset
};
