...
class AnimationComponent extends Component {
  constructor() {
     ...
     * @ignore
     */
    __publicField(this, "animEvaluator", null);
    /**
     * @type {Model|null}
     * @ignore
     */
     ...
     * @ignore
     */
    __publicField(this, "fromSkel", null);
    /**
     * @type {Skeleton|null}
     * @ignore
     */
    __publicField(this, "toSkel", null);
    /**
     * @type {Object<string, string>}
     * @ignore
     */
    __publicField(this, "animationsIndex", {});
    /**
     ...
     * @private
     */
    __publicField(this, "_boundAssets", /* @__PURE__ */ new Set());
    /**
     ...
     * @private
     */
    __publicField(this, "_pendingAssetAdds", /* @__PURE__ */ new Set());
    /**
     * @type {string|null}
     * @private
     */
    __publicField(this, "prevAnim", null);
    /**
     * @type {string|null}
     * @private
     */
    __publicField(this, "currAnim", null);
    /** @private */
    __publicField(this, "blend", 0);
    /** @private */
    __publicField(this, "blending", false);
    /** @private */
    __publicField(this, "blendSpeed", 0);
    /**
     * If true, the first animation asset will begin playing when the scene is loaded.
     */
    __publicField(this, "activate", true);
    /**
  ...
  play(name, blendTime = 0) {
    ...
    if (this.model) {
      ...
      if (this.animEvaluator) {
        ...
        const clip = new AnimClip(this.animations[this.currAnim], 0, 1, true, this.loop, this);
