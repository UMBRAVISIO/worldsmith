...
class GSplatHybridRenderer extends GSplatRenderer {
  ...
  constructor(device, node, cameraNode, layer, workBuffer, scratch = null) {
    ...
    __publicField(this, "_pickMaterial", null);
    /** @type {MeshInstance|null} */
    __publicField(this, "_pickMeshInstance", null);
    /**
     ...
     * @type {Float32Array}
     */
    __publicField(this, "_clipToViewZ", new Float32Array(4));
    /**
     ...
     */
    __publicField(this, "_clipToViewZPick", null);
    /** @type {number} */
    __publicField(this, "originalBlendType", BLEND_ADDITIVE);
    /** @type {Set<string>} */
    __publicField(this, "_internalDefines", /* @__PURE__ */ new Set());
    /** @type {string} */
    __publicField(this, "_lastSourceChunksKey", "");
    /** @type {number} */
    __publicField(this, "_sourceMaterialVersion", -1);
    /**
     * The projection cache stride in u32 words: the base layout plus user varying stream words.
     *
     * @type {number}
     */
    __publicField(this, "_cacheStride", CACHE_STRIDE);
    /**
