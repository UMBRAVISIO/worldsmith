...
class ParticleEmitter {
  constructor(graphicsDevice, options) {
    ...
    /** @type {Texture|null} */
    __publicField(this, "internalTex0", null);
    /** @type {Texture|null} */
    __publicField(this, "internalTex1", null);
    /** @type {Texture|null} */
    __publicField(this, "internalTex2", null);
    /** @type {Texture|null} */
    __publicField(this, "colorParam", null);
  ...
  calculateWorldBounds() {
    if (!this.node) return;
    const recalculateLocalBounds = this.emitterShape === EMITTERSHAPE_BOX ? !this.emitterExtents.equals(this.prevEmitterExtents) : this.emitterRadius !== this.prevEmitterRadius;
