...
class Renderer {
  ...
  constructor(graphicsDevice, scene) {
    /** @type {boolean} */
    __publicField(this, "clustersDebugRendered", false);
    /** @type {Scene} */
     ...
     * @ignore
     */
    __publicField(this, "culler");
    /**
     * @type {WorldClustersAllocator}
     * @ignore
     */
    __publicField(this, "worldClustersAllocator");
    /**
     ...
     * @type {Light[]}
     */
    __publicField(this, "localLights", []);
    /**
     ...
     */
    __publicField(this, "_viewUniformBuffers", /* @__PURE__ */ new WeakMap());
    /**
     * Reusable receiver for a view uniform buffer's dynamic bind group + offset.
     *
     * @type {DynamicBindGroup}
     */
    __publicField(this, "_dynamicViewBindGroup", new DynamicBindGroup());
    /**
     ...
     * @type {BindGroup[]}
     */
    __publicField(this, "_viewBindGroups", []);
    /** @type {number[]} */
    __publicField(this, "_viewBindGroupOffsets", []);
    /**
     ...
     * @type {number[]}
     */
    __publicField(this, "_viewOffsetScratch", [0]);
    __publicField(this, "blueNoise", new BlueNoise(123));
    /**
     * A gsplat director for unified splat rendering.
     *
     * @type {GSplatDirector|null}
     */
    __publicField(this, "gsplatDirector", null);
