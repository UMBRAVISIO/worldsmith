...
class Light {
  ...
  constructor(graphicsDevice, clusteredLighting) {
     ...
     * @type {boolean}
     */
    __publicField(this, "clusteredLighting");
    /**
     * The depth state used when rendering the shadow map.
     *
     * @type {DepthState}
     */
    __publicField(this, "shadowDepthState", DepthState.DEFAULT.clone());
    /**
     ...
     * @type {number}
     */
    __publicField(this, "volumetricScattering", 1);
    /**
     ...
     * @ignore
     */
    __publicField(this, "clusteredFlags", 0);
    /**
     ...
     * @ignore
     */
    __publicField(this, "clusteredData", new Uint32Array(3));
    /**
     ...
     * @ignore
     */
    __publicField(this, "clusteredData16", new Uint16Array(this.clusteredData.buffer));
    /**
   ...
   */
  updateKey() {
    let key = this._type << 29 | this._shadowType << 25 | this._falloffMode << 23 | (this._normalOffsetBias !== 0 ? 1 : 0) << 22 | (this._cookie ? 1 : 0) << 21 | (this._cookieFalloff ? 1 : 0) << 20 | chanId[this._cookieChannel.charAt(0)] << 18 | (this._cookieTransform ? 1 : 0) << 12 | this._shape << 10 | (this.numCascades > 1 ? 1 : 0) << 9 | (this._cascadeBlend > 0 ? 1 : 0) << 8 | (this.affectSpecularity ? 1 : 0) << 7 | this.mask << 6 | (this._castShadows ? 1 : 0) << 3;
