...
class LitShader {
  ...
  constructor(device, options, allowWGSL = true) {
    ...
    this.needsNormal = this.lighting || this.reflections || options.useRefraction || options.useSpecular || options.ambientSH || options.useHeights || options.enableGGXSpecular || options.clusteredLightingEnabled && !this.shadowPass || options.useClearCoatNormals;
