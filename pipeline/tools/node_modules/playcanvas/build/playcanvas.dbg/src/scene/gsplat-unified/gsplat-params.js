...
class GSplatParams {
  ...
  constructor(device) {
     ...
     * @private
     */
    __publicField(this, "_material", new ShaderMaterial());
    /**
     ...
     * @private
     */
    __publicField(this, "_dataFormat", GSPLATDATA_COMPACT);
    /**
     ...
     */
    __publicField(this, "radialSorting", false);
    /**
     * @type {number}
     * @private
     */
    __publicField(this, "_renderer", GSPLAT_RENDERER_AUTO);
    /**
     ...
     * @private
     */
    __publicField(this, "_currentRenderer", GSPLAT_RENDERER_RASTER_CPU_SORT);
    /**
     ...
     * @private
     */
    __publicField(this, "_debug", GSPLAT_DEBUG_NONE);
    /** @private */
    __publicField(this, "_enableIds", false);
    /**
     * Distance threshold in world units to trigger LOD updates for camera and gsplat instances.
     * Defaults to 1.
     */
    __publicField(this, "lodUpdateDistance", 1);
    /**
     ...
     */
    __publicField(this, "lodUpdateAngle", 0);
    /** @private */
    __publicField(this, "_lodBehindPenalty", 1);
    /** @private */
    __publicField(this, "_lodUnderfillLimit", 0);
    /** @private */
    __publicField(this, "_splatBudget", SPLAT_BUDGET_DEFAULT);
    /** @private */
    __publicField(this, "_lodMode", GSPLAT_LODMODE_DISTANCE);
    /**
     * @type {import('../../platform/graphics/texture.js').Texture|null}
     * @private
     */
    __publicField(this, "_colorRamp", null);
    /**
     ...
     */
    __publicField(this, "colorRampIntensity", 1);
    /**
     ...
     */
    __publicField(this, "colorUpdateAngle", 10);
    /** @private */
     ...
     * @type {boolean}
     */
    __publicField(this, "sceneDepthWrite", false);
    /**
     * @type {GSplatVaryings}
     * @private
     */
    __publicField(this, "_varyings");
    /**
     ...
     * @private
     */
    __publicField(this, "_appliedVaryingsVersion", 0);
    this._device = device;
