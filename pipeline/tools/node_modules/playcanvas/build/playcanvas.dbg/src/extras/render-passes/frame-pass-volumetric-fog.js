...
class RenderPassVolumetricFog extends RenderPassShaderQuad {
  constructor(device, cameraComponent) {
    super(device);
    /** @type {Light|null} */
    __publicField(this, "light", null);
    __publicField(this, "shadowsEnabled", false);
    /**
     * The shadow data of the light for the fog camera, when the shadow map is available.
     *
     * @type {LightRenderData|null}
     */
    __publicField(this, "lightRenderData", null);
    __publicField(this, "tint", new Color(1, 1, 1));
    __publicField(this, "density", 0.01);
    __publicField(this, "heightBase", 0);
    __publicField(this, "heightFalloff", 0.05);
    __publicField(this, "extinction", 1);
    __publicField(this, "anisotropy", 0.6);
    __publicField(this, "intensity", 1);
    __publicField(this, "ambientColor", new Color(1, 1, 1));
    __publicField(this, "ambientIntensity", 0.02);
    __publicField(this, "maxDistance", 300);
    __publicField(this, "steps", 24);
    __publicField(this, "noiseOffset", 0);
    __publicField(this, "exposure", 1);
    /** @type {string|null} */
    __publicField(this, "_variantKey", null);
