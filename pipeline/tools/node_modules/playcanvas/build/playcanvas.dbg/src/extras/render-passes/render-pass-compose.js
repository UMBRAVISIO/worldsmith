...
class RenderPassCompose extends RenderPassShaderQuad {
  ...
  constructor(graphicsDevice, cameraComponent) {
    ...
    __publicField(this, "_sceneDepthAvailable", false);
