...
class WideLineRenderer {
  ...
  constructor(app) {
    ...
    __publicField(this, "_depthWrite", true);
    __publicField(this, "_enabled", true);
    __publicField(this, "_widthUnits", LINEWIDTH_SCREEN);
    __publicField(this, "_capacity", 0);
    __publicField(this, "_segmentCount", 0);
    __publicField(this, "_dirty", true);
    __publicField(this, "_destroyed", false);
    /** @type {VertexBuffer|null} @ignore */
    __publicField(this, "_vertexBuffer", null);
    /** @type {Float32Array|null} @ignore */
    __publicField(this, "_instanceData", null);
    this.app = app;
