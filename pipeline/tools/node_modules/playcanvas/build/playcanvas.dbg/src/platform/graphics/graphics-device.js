...
const _GraphicsDevice = class _GraphicsDevice extends EventHandler {
  constructor(canvas, options) {
     ...
     * @readonly
     */
    __publicField(this, "supportsSubgroupSizeControl", false);
    /**
     ...
     * @readonly
     */
    __publicField(this, "supportsTransientAttachments", false);
    /**
     ...
     * @readonly
     */
    __publicField(this, "supportsDualSourceBlending", false);
    /**
     ...
     * @readonly
     */
    __publicField(this, "supportsIndependentBlending", false);
    /**
     ...
     * @readonly
     */
    __publicField(this, "textureFloatBlendable", false);
    /**
    ...
    for (let i = 0; i < formats.length; i++) {
      ...
      switch (format) {
        ...
        case PIXELFORMAT_RGBA32F:
          ...
          if (this.textureFloatRenderable && (!filterable || this.textureFloatFilterable) && (!blendable || this.textureFloatBlendable)) {
            return format;
          }
          break;
      }
