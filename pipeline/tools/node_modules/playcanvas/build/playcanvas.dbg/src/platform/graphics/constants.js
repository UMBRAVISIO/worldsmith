...
const BLENDMODE_SRC1_COLOR = 13;
const BLENDMODE_ONE_MINUS_SRC1_COLOR = 14;
const BLENDMODE_SRC1_ALPHA = 15;
const BLENDMODE_ONE_MINUS_SRC1_ALPHA = 16;
...
const TRANSFORM_FEEDBACK_INTERLEAVED = 0;
const TRANSFORM_FEEDBACK_SEPARATE = 1;
...
const RENDERTARGET_ORIGIN_TOP = "top";
const RENDERTARGET_ORIGIN_BOTTOM = "bottom";
const RENDERTARGET_ORIGIN_NATIVE = "native";
...
const isMultisampleCapablePixelFormat = (format) => {
  return pixelFormatInfo.get(format)?.msaa === true;
};
const isMultisampleResolveCapablePixelFormat = (format) => {
...
export {
  ...
  isMultisampleResolveCapablePixelFormat,
  isSrgbPixelFormat,
