...
class ColorAttachment {
  constructor() {
     ...
     * @type {boolean}
     */
    __publicField(this, "transient", false);
    /**
  ...
  setupForRenderPass(renderPass, renderTarget) {
    ...
    for (let i = 0; i < count; ++i) {
      ...
      if (this.colorAttachments[i]?.resolveView) {
        colorAttachment.resolveTarget = colorOps.resolve ? this.colorAttachments[i].resolveView : void 0;
      }
