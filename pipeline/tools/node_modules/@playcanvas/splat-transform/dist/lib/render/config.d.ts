 ...
 */
export declare const AA_DILATION_COV = 0.3;
/**
 ...
 */
export declare const JACOBIAN_LIMIT_FACTOR = 1.3;
/**
 ...
 * reference.
 */
export declare const OPACITY_CAP = 0.99;
/**
 ...
 */
export declare const MIN_ALPHA: number;
/**
 ...
 * reference.
 */
export declare const MIN_TRANSMITTANCE = 0.0001;
/**
 ...
 */
export declare const DISCRIMINANT_FLOOR = 0.1;
/**
 ...
 */
export declare const SIGMA_CUTOFF = 3;
/**
 ...
 */
export declare const GAUSSIAN_FLOOR: number;
/**
 ...
 */
export declare const FAR_PLANE_NEAR_FACTOR = 100;
/**
 ...
 */
export declare const POLE_EPS = 0.005;
/**
 ...
 */
export declare const PAIR_BUFFER_BUDGET_BYTES: number;
/**
 ...
 * pipeline.
 */
export declare const PAIR_BUFFER_TOTAL_BYTES_PER_ELEMENT: number;
/**
 ...
 */
export declare const storageBindingLimit: (device: GraphicsDevice) => number;
/**
 ...
 */
export declare const rasterChunkCap: (device: GraphicsDevice, maxCoveragePerSplat: number, budgetBytes?: number) => number;
/**
 ...
 */
export declare const RADIUS_FADE_START_FRAC: number;
export declare const RADIUS_FADE_END_FRAC: number;
